...
class xml_parser(object):
    ...
    # Function to parse execution.xml 
                ...
                if execute.get('name') == execution_name:
                    ...
                    for element in execute:
                        if element.tag == "testcase":
                            ...
                            if element.get("name") == "enumeration" or element.get("name") == "abortion-enumeration":
...
print len(xml_parser("test.xml", "testcase.xml", "execution.xml").calc_tests("ex2"))
